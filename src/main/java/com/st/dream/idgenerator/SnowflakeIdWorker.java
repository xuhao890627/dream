package com.st.dream.idgenerator;
 ...
 * 
 * 已经修改了产生的序列<br>
 * workerIdBits之前是5现在是4 <br>
 * datacenterIdBits之前是5现在是4<br>
 * sequenceBits之前是12现在是8<br>
 * 这样可以使用年限边长，我们程序也用不到这么多子节点，和每毫秒的生成序列 ^_^
 */
public class SnowflakeIdWorker {
	...
	/** 生成序列的掩码，这里为255 (0b11111111=0xfff=255) */
